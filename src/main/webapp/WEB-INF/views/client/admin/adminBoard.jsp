                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ms-auto"><span class="counter text-success">${tToday}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Today Visitor</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                                ...
                                <li class="ms-auto"><span class="counter text-purple">${vToday}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
...
<!--                                     </tbody> -->
									 <tbody>
			                            <!-- 여기에서 데이터를 반복합니다. 간결함을 위해 하나의 행만 표시합니다. -->
			                            <c:forEach var="row" items="${yourDataList}">
			                                <tr>
			                                    <td>${row.id}</td>
			                                    <td>${row.firstName}</td>
			                                    <td>${row.lastName}</td>
